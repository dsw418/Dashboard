...
require(["js/qlik"], function (qlik) {
	...
	app.getObject('QV2-03','pjJFm');
	
	
	app.getObject('QV2-02','fuejJ');
	
	
	app.getObject('KPI-05','gLQSS');
	app.getObject('KPI-06','yVjvP');
	
	
	
	
	
	app.getObject('KPI-04','dfJyHD');
	...
	app.getObject('QV3-05','xKYDKQ');
	app.getObject('QV3-03','fREG');
